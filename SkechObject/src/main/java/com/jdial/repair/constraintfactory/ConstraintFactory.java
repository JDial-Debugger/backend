...
public class ConstraintFactory {
	...
	// IOmod
	public static List<Trace> ori_trace_list;
	static List<TracePoint> target_trace_list;
	...
	public ConstraintFactory(Trace oriTrace, TracePoint finalState, FcnHeader fh) {
