...
/**
 * Used to represent an assertion for a function call. These should not be used for the parse tree
 * of an actual program's code, but used to enforce assertions for JDial's function assertion
 * feature
 *
 */
public class StmtFuncAssert extends Statement {
	 ...
	 * @param expression  - what expression the function should evaluate to this can be any non
