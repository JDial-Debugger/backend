...
public class StmtFor extends Statement {
	...
	public StmtFor(Statement init, Expression cond, Statement incr, Statement body) {
	...
	public Map<String, Type> addRecordStmt(StmtBlock parent, int index, Map<String, Type> m) {
		...
		return ((StmtBlock) ((StmtBlock) body).stmts.get(0)).stmts.get(
			((StmtBlock) ((StmtBlock) body).stmts.get(0)).stmts.size() - 1
		).addRecordStmt((StmtBlock) body, 1, m);
	}
	...
	public Statement insertRecordStmt(
		...
		this.body
			= this.getBody().insertRecordStmt(funcName, funcType, correctionLine, correctionVars);
