...
public class StmtIfThen extends Statement {
	...
	/**
	 * Create a new conditional statement, with the specified condition, consequent, and
	 * alternative. The two statements may be null if omitted.
	 * 
	 * @param i
	 */
	...
	public Map<String, Type> addRecordStmt(StmtBlock parent, int index, Map<String, Type> m) {
		...
		// System.err.println("cons is " + cons.getPostctx().getLinenumber() +
		// cons.getPostctx().getAllVars());
		if (alt != null) {
			if (Global.prime_mod)
	...
	public Statement insertRecordStmt(
		...
		this.cons
			= this.getCons().insertRecordStmt(funcName, funcType, correctionLine, correctionVars);
		if (this.getAlt() != null) {
			this.alt.insertRecordStmt(funcName, funcType, correctionLine, correctionVars);
		}
