...
public class Errors {
	...
	public static final String USAGE
		= "usage: java RepairEngine <tracePointCorrection | funcCorrection> <json>";
	public static final String TRIM_ARGS = "Target function or call line not supplied";

	// Testing only
	public static final String wrongException(Exception wrongEx) {
		return "Threw the incorrect exception: " + wrongEx.toString();
	}
	public static final String NO_EXCEPTION = "Did not throw any exception";
}
