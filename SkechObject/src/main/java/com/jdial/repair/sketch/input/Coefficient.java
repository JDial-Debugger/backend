...
public abstract class Coefficient {
	...
	public Coefficient(int idx, TypePrimitive type, ExprBinaryFactory binaryExprFactory) {
		this(idx, type, -1, binaryExprFactory);
	}
	...
	public Coefficient(
		...
		this(idx, type, lineNumber, null, binaryExprFactory);
	}
